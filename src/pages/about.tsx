...
import MattHeadshot from "../../public/headshots/matt_headshot.jpg";
    ...
    <AnimatePresence>
      ...
      <div className="min-h-[100vh] sm:min-h-screen w-screen flex flex-col relative bg-[#2C2C2C] font-inter overflow-hidden">
        ...
        <main className="flex flex-col justify-center h-[90%] static md:fixed w-screen overflow-hidden grid-rows-[1fr_repeat(3,auto)_1fr] z-[100] pt-[30px] pb-[320px] px-4 md:px-20 md:py-0">
          ...
          >
            Our team is passionate about making a difference in the world. We
            participated in Robinhood's Social Good hackathon with the aim of
            creating a platform that not only informs but also connects
            communities during health crises. We believe in the power of
            information, collaboration, and community-driven solutions.
          </motion.p>
